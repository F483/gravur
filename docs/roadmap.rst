...
+------+-----------+-----------+---+------------------------------------------+
| 1.2  | 4h        |           |   | CLI prototype, public broadcast only     |
+------+-----------+-----------+---+------------------------------------------+
| 1.3  | 2h        |           |   | Funding pitch and lighthouse project     |
+------+-----------+-----------+---+------------------------------------------+
| 1.4  | 2h        |           |   | Static github page homepage              |
+------+-----------+-----------+---+------------------------------------------+
| 1.5  | 6h        |           |   | Promote funding stage 1                  |
+------+-----------+-----------+---+------------------------------------------+
| 2    | Required plumbing                                                    |
+------+-----------+-----------+---+------------------------------------------+
| 2.1  | 0h        | 0h        | ✔ | Store data in nulldata output            |
+------+-----------+-----------+---+------------------------------------------+
| 2.2  | 3h        |           |   | Store data in hash160 output             |
+------+-----------+-----------+---+------------------------------------------+
| 2.3  | 0h        | 0h        | ✔ | Sign data                                |
+------+-----------+-----------+---+------------------------------------------+
