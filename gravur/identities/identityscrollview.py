...
from gravur.identities.identitypreview import IdentityPreview
from gravur.utils import load_widget


@load_widget
class IdentityScrollView(AbstractScrollView):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(IdentityScrollView, self).__init__(*args, **kwargs)

    def entry_to_widget(self, entry):
        return IdentityPreview(**entry)
